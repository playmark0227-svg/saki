...
const STORY = {
  ...
  p_5b: {
    bg: "schoolgate_petals", who: "saki", exp: "smile", text: [
      ...
      "彼女はぺこりと頭を下げてから、わたしの顔をじっと見た。",
    ], next: "p_6",
  },
  p_5c: {
    bg: "schoolgate_petals", who: "saki", exp: "normal", text: [
      "「……えっと、固まっちゃってるけど、大丈夫？」",
      "彼女は首をかしげながら、わたしの顔をのぞき込んだ。",
    ], next: "p_6",
  },
  ...
  p_8: {
    bg: "classroom", who: "", text: [
      "教室に着くと、あかりは「またあとでね！」と自分の席へ駆けていった。",
  ...
  p_14: {
    bg: "hallway_sunset", who: "", text: [
      ...
      "たった一日で、三人の少女と、一人の――特別な先輩に出会った。",
      "眩しいあかり。凛とした雪乃。儚いひなた。そして、学園中の憧れ、シオン先輩。",
  ...
  d1_1: {
    bg: "schoolgate", who: "saki", exp: "happy", text: [
      "「{name}、おはよー！ あっ、待ってよー！」",
      "翌朝、校門であかりが駆け寄ってきた。息を切らしながら、満面の笑み。",
      "「ねえねえ、一緒に行こ？ ……だめ？」",
    ],
    choices: [
  ...
  d1_4: {
    bg: "schoolgate_petals", who: "saki", exp: "sad", text: [
      ...
      "一瞬だけ寂しそうに笑って、あかりはまた元気いっぱいに駆け出した。",
    ], next: "d1_5",
  },
  d1_4b: {
    bg: "schoolgate_petals", who: "saki", exp: "surprise", text: [
  ...
  d1_end: {
    bg: "home_evening", who: "player", text: [
      ...
      "（あのしおりの“約束”。あかりの意味ありげな言葉。ひなたの空白の絵。）",
  ...
  d2_1: {
    bg: "gym", who: "", text: [
      ...
      "ひとり、シュート練習を続けるあかり。汗を光らせ、何度も、何度も。",
  ...
  d2_end: {
    bg: "home_evening", who: "player", text: [
      ...
      "（あかりの“置いていかれる怖さ”。雪乃の“縛られた夢”。ひなたの“消える儚さ”。シオンの“凍った指”。）",
  ...
  d3_2: {
    ...
    choices: [
      { label: "あかりと、文化祭の準備をする", eff: { saki: 3 }, next: "d3_saki" },
  ...
  d3_yukino: {
    bg: "library", who: "yukino", exp: "shy", text: [
      ...
      "ふと、彼女が書きかけの物語のノートを、そっとわたしのほうへ押し出した。",
  ...
  /* ===================== あかりルート ===================== */
  saki_4_title: { startDay: 4, dayTitle: "四日目 ―― 結城 あかり", next: "saki_4_1" },
  saki_4_1: {
    bg: "schoolgate_petals", who: "saki", exp: "smile", text: [
  ...
  saki_4_5a: {
    bg: "park_sakura", who: "saki", exp: "surprise", text: [
      "あの押し花のしおりを差し出すと、あかりの目が大きく見開かれた。",
      "「……それ。あたしが、{name}にあげたやつ……! 持ってて、くれたの……?」",
      "ぽろり、と涙がこぼれた。",
      "『さくらの き の した で、また あおうね。やくそく。』――あの字は、幼いあかりのものだった。",
    ], next: "saki_4_6",
  },
  saki_4_5b: {
  ...
  saki_4_7: {
    bg: "park_sunset", who: "player", text: [
      "（思い出した。小さなわたしは、泣きじゃくるあかりに、約束したんだ。）",
  ...
  saki_4_8: {
    bg: "park_sunset", who: "saki", exp: "blush", text: [
      "あかりは、わたしの胸で、子どものように泣いた。それから、顔を上げて笑った。",
  ...
  saki_5_1: {
    bg: "gym", who: "saki", exp: "normal", text: [
      "翌日。あかりは、ずっと避けていた体育館に、自分から足を運んだ。",
  ...
  saki_climax: {
    bg: "festival_night", who: "saki", exp: "blush", text: [
      ...
      "試合をやり遂げたあかりが、わたしの手を取って、人混みの外へと駆け出した。",
  ...
  saki_true: {
    ...
    text: [
      "わたしの答えに、あかりは、泣きながら、世界で一番の笑顔を見せた。",
  ...
  saki_good: {
    ...
    text: [
      "差し出した手を、あかりはぎゅっと握り返した。少し照れながら、でも確かに。",
  ...
  yukino_6_1: {
    bg: "library_sunset", who: "yukino", exp: "shy", text: [
      "文化祭前夜。雪乃は、一冊のノートをわたしに手渡した。新作の物語。",
  ...
  yukino_climax: {
    bg: "festival_night", who: "yukino", exp: "blush", text: [
      "――文化祭、最終日の夜。展示を終えた雪乃が、わたしを屋上へと呼び出した。",
  ...
  yukino_true: {
    ...
    text: [
      "わたしの答えに、氷の会長と呼ばれた彼女が、花のようにほどけて笑った。",
  ...
  yukino_good: {
    ...
    text: [
      "わたしが頷くと、雪乃は照れたように、けれど嬉しそうに目を細めた。",
      "「不器用なの、知ってるでしょう。だから……ゆっくり、進ませて。」",
      "「私とあなたの物語は、まだ一行目。これから、二人で書いていきましょう。」",
      "夢へ踏み出した彼女の隣に、わたしはいる。それだけで、明日が待ち遠しかった。",
    ],
  },
  yukino_bad: {
  ...
  hinata_4_5b: {
    bg: "artroom_sunset", who: "hinata", exp: "blush", text: [
      "「いっしょに……?」",
      "彼女は筆を握る手を、そっとわたしの手に重ねた。あたたかかった。",
