...
const STORY = {
  ...
  hinata_4_6: {
    bg: "riverside_sunset", who: "hinata", exp: "smile", text: [
      ...
      "「ねえ、{name}くん。僕、決めた。あの絵、文化祭までに完成させる。」",
  ...
  hinata_true: {
    ...
    text: [
      ...
      "「やった……。僕、“この先”が、見たくなっちゃった。{name}くんと。」",
  ...
  hinata_bad: {
    ...
    text: [
      ...
      "「この絵は、ずっと残るよ。僕が、{name}くんを好きだった“今”も、ずっと。」",
