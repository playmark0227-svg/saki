...
const STORY = {
  ...
  d2_shion_2: {
    bg: "courtyard_sunset", who: "shion", exp: "sad", text: [
      ...
      "「でも――大事な本番で大失敗して以来、まともに弾けなくなった。姉とも、うまく話せていない。」",
    ],
    choices: [
  ...
  d2_shion_3a: {
    bg: "courtyard_sunset", who: "shion", exp: "normal", text: [
      "「……鋭いな。」 彼は自嘲気味に笑った。",
      "「鍵盤の前に座ると、あの日の失敗がよみがえる。指が、凍りつくんだ。」",
  ...
  saki_climax: {
    ...
    choices: [
      { label: "「わたしも好き。……これからは、恋人として、よろしくね」", eff: { saki: 3 }, next: "saki_end_branch" },
  ...
  yukino_climax: {
    bg: "festival_night", who: "yukino", exp: "blush", text: [
      ...
      "「……ノートの最後の一行は、まだ書けていないんだ。」",
      "「だから、口で言う。柄じゃないけど。」",
      "「{name}。好きだ。その、……よかったら、付き合ってほしい。」",
    ],
    choices: [
      { label: "「わたしも好き。……これから、よろしくね」", eff: { yukino: 3 }, next: "yukino_end_branch" },
  ...
  hinata_mid_2: {
    bg: "infirmary", who: "", text: [
      "その翌日、ひなたは美術室で、ふいに顔色を悪くした。",
      "「ちょっと、めまいが……ごめん、平気だよ」。でも、指先は冷たくて、少しふらついていた。",
      "付き添った保健室で、彼は申し訳なさそうに笑った。",
  ...
  hinata_climax: {
    bg: "festival_night", who: "hinata", exp: "blush", text: [
      ...
      "「{name}さん。僕ね、きみといる時間が、いちばん好きなんだ。……その、好きです。」",
    ],
    choices: [
      { label: "「わたしも好き。これから、少しずつでいいから」", eff: { hinata: 3 }, next: "hinata_end_branch" },
  ...
  shion_4_3: {
    bg: "musicroom_sunset", who: "shion", exp: "sad", text: [
      "「三年前のコンクールで、大舞台の途中、頭が真っ白になった。」",
      "「客席には、ピアノを教えてくれた姉さんもいた。……最悪の演奏だった。」",
      "「期待に応えられなくて、合わせる顔がなくて。それ以来、鍵盤の前に座ると、手が震える。」",
      "「逃げ続けて、三年だ。……情けないだろう。」",
    ], next: "shion_4_4",
  },
  shion_4_4: {
    ...
    choices: [
      { label: "「君のせいじゃない。お姉さんは、きっとまだ君の音を待ってる」", eff: { shion: 4 }, flag: { shion_b1: true }, next: "shion_4_5a" },
      { label: "「もう一度、弾けばいい。まずはわたしが聴くから」", eff: { shion: 4 }, next: "shion_4_5b" },
    ],
  },
  shion_4_5a: {
    bg: "musicroom_sunset", who: "shion", exp: "surprise", text: [
  ...
  shion_5_1: {
    bg: "musicroom", who: "shion", exp: "normal", text: [
      ...
      "「三年ぶりに、人前で弾く。……いつか姉さんにも、そして、お前に、聴いてほしい曲があるんだ。」",
    ],
    choices: [
  ...
  shion_climax: {
    bg: "auditorium_night", who: "shion", exp: "blush", text: [
      ...
      "「……久しぶりに、人前で最後まで弾けた。お前が、聴いていてくれたからだ。」",
      "「{name}。こんな年上で悪いが……好きだ。よかったら、付き合ってほしい。」",
    ],
    choices: [
      { label: "「わたしも好きです。……はい、よろしくお願いします」", eff: { shion: 3 }, next: "shion_end_branch" },
